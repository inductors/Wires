...
<form id="serial" runat="server">
    ...
    <div id="logger">
        <div id="save_tools" align="left">
        <pre>
        <span class="style1"><strong>Student Name:</strong></span>  <input type="text" id="txtName" />    <input 
                type="button" name="myotherbutton" value="Save Progress" id="logBut" />    
        </pre>
        <pre>
&nbsp;</pre>
       </div>
